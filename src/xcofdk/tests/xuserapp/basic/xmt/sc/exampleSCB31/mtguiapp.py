...
from xuserapp.basic.xmt.sc.exampleSCB31.maintask import MainTaskGIL
...
def Main(cmdLineOpts_ : CLOptions):
    ...
    _myMXT = MainTaskGIL.CreateSingleton(None, cmdLineOpts_)
    if _myMXT is None:
        return 71
...
if __name__ == "__main__":
    _opts = [ ECLOptionID.eFiboInput , ECLOptionID.eForceDeficientFreq ]
