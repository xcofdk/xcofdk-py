...
from xuserapp.basic.xmt.sc.exampleSCB23.maintask import MainTaskBlockingServiceTasks
...
def Main(cmdLineOpts_ : CLOptions):
    ...
    _myMXT = MainTaskBlockingServiceTasks.CreateSingleton(None, cmdLineOpts_)
    if _myMXT is None:
        return 71
