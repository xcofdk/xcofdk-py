...
class MainTaskBlockingServiceTasks(_MainTask):
    ...
    def __init__(self, cmdLineOpts_ : CLOptions, taskProfile_ : XTaskProfile =None):
        super().__init__(cmdLineOpts_, taskProfile_=taskProfile_, guiTitle_='XMTGuiAppBlockingSrvTask', bBroadcast_=False, bBlockingSrvTask_=True)
    ...
    def _CreateSingleton(taskProfile_ : Union[XTaskProfile, None], cmdLineOpts_ : CLOptions):
        res = MainTaskBlockingServiceTasks(cmdLineOpts_, taskProfile_=taskProfile_)
