...
from xuserapp.basic.xmt.sc.exampleSCB11.maintask import MainTask
...
def Main(cmdLineOpts_ : CLOptions):
    """
    Main script of example exampleSCB11.


    Purpose of exampleSCB11:
    -------------------------
    Main objective of this example is to:
        a) demonstrate subclassing (SC) approach to create application tasks.
    ...
    _myMXT = MainTask.CreateSingleton(None, cmdLineOpts_)
    if _myMXT is None:
        return 71
