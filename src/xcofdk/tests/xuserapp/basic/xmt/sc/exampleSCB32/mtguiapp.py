...
from xuserapp.basic.xmt.sc.exampleSCB32.maintask import MainTaskGIL2
...
def Main(cmdLineOpts_ : CLOptions):
    ...
    _myMXT = MainTaskGIL2.CreateSingleton(None, cmdLineOpts_)
    if _myMXT is None:
        return 71
    ...
    # step 5: make program termination is synchronized to framework's coordinated shutdown
