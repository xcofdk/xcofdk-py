...
class MainTaskCustomPayload(_MainTask):
    ...
    def __init__(self, cmdLineOpts_ : CLOptions, taskProfile_ : XTaskProfile =None):
        super().__init__(cmdLineOpts_, taskProfile_=taskProfile_, guiTitle_='XMTGuiAppCustomPayload', bCustomPayLoad_=True)
    ...
    def _CreateSingleton(taskProfile_ : Union[XTaskProfile, None], cmdLineOpts_ : CLOptions):
        res = MainTaskCustomPayload(cmdLineOpts_, taskProfile_=taskProfile_)
