...
class DetailViewMainTaskGILFrame(UserAppViewIF):
    ...
    #             +-------------------------+--------------------------+--------------+
    #         6:  | lblSntMsgErrText        | lblSntMsgErrValue        |              |
    #             +-------------------------+--------------------------+--------------+
    #         7:  | lblOutOfOrderText       | lblOutOfOrderValue       |              |
    #             +-------------------------+--------------------------+--------------+
    #         8:  | lblSntMsgTotalErrText   | lblSntMsgTotalErrValue   |              |
    #             +------------------------ +--------------------------+--------------+
    #         9:  | lblOutOfOrderTotalText  | lblOutOfOrderTotalValue  |              |
    #             +------------------------ +--------------------------+--------------+
    #
    # ------------------------------------------------------------------------------
